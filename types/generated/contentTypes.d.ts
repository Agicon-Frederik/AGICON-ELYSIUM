...
export interface ApiNavigatieNavigatie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::navigatie.navigatie'
    >;
    Locatie: Schema.Attribute.Enumeration<['Header', 'Footer', 'Allebei']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Volgorde: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOpleidingOpleiding extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    afbeelding: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Introductie: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    opleidingscategorie: Schema.Attribute.Relation<
      'manyToOne',
      'api::opleidingscategorie.opleidingscategorie'
    >;
    opleidingssessies: Schema.Attribute.Relation<
      'oneToMany',
      'api::opleidingssessie.opleidingssessie'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiOpleidingscategorieOpleidingscategorie
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::opleidingscategorie.opleidingscategorie'
    >;
    Omschrijving: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    opleidingen: Schema.Attribute.Relation<
      'oneToMany',
      'api::opleiding.opleiding'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOpleidingssessieOpleidingssessie
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deelnemers: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    opleiding: Schema.Attribute.Relation<
      'manyToOne',
      'api::opleiding.opleiding'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPaginaPagina extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pagina.pagina'>;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::opleiding.opleiding': ApiOpleidingOpleiding;
      'api::opleidingscategorie.opleidingscategorie': ApiOpleidingscategorieOpleidingscategorie;
      'api::opleidingssessie.opleidingssessie': ApiOpleidingssessieOpleidingssessie;
